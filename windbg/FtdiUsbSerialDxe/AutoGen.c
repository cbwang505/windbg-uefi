...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x38C85805, 0x883F, 0x4ee8, {0xA8, 0x54, 0x95, 0xB9, 0x66, 0xED, 0x73, 0xAA}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DebugAgentDxe";
...
#define _PCD_VALUE_PcdDebugLoadImageMethod  0x1U
...
{
  return DebugAgentDxeInitialize (ImageHandle, SystemTable);
}
...
{
  return DebugAgentDxeUnload (ImageHandle);
}
